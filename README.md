...
| Usage delivery | Gateway foundation | Prompt-free bounded spool, integrity, restart recovery, ordered replay, contiguous acknowledgement, reclamation, compaction, and a frozen Cloud batch/ACK body contract (`docs/usage-cloud-ingest.md`); production Cloud HTTP transport and ledger ingest remain open |
