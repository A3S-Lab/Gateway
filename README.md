...
| Model-specific access | Endpoint/model grants, alias rewriting, RPM, burst, concurrent-request admission, and local `tokens_per_minute` reservation via provisional `a3s.gateway.tokenizer.v1` |
